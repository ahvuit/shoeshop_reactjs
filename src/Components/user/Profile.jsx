...
const Profile = () => {
  ...
  return (
    <><div style={{ border: '1px solid #ccc', padding: '0.5rem' }}>
      ...
      <Row justify="center" style={{ marginTop: '1rem' }}>
        <Col span={8}>
          <Button type="primary" style={{ background: "var(--primary-color)" }} onClick={() => { setOpenModal(true); } }>
            Edit Profile
          </Button>
        </Col>
      </Row>
    </div><ProfileModal openModal={openModal} setOpenModal={setOpenModal} profile={profile} /></>
  );
};
